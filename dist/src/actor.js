 ...
 */
const walkerKeys = ["ignorant", "ignoranceSpreader"];
/**
 * All the different actor kinds.
 */
const kindKeys = [...walkerKeys, "goodGuy", "ground", "spawner", "spaghettiMonster", "player"];
/**
...
function translateAndUpdateWaypoint(actors, movingActor, movementVector) {
    ...
    if ((isWalker(movingActor)) && isDeepStrictEqual(newPosition, getWaypointTarget(movingActor))) {
        ...
        return setWaypointTargetNumber(setWaypointTarget({ ...movingActor, position: newPosition }, nextWaypoint.waypointTarget), nextWaypoint.waypointTargetNumber);
    }
