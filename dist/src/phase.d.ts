 ...
 * @returns A new phase
 */
declare function createPhase<Key extends keyof ActorActions>(funcName: Key & (keyof ActorActions), executePhase: (oldActors: Array<Actor>, phaseResults: Array<ReturnType<ActorActions[Key]>>) => Array<Actor>): Phase;
export type { Phase };
export { createPhase };
