...
import { stringReplaceAt } from "./utils/other_utils";
/**
 * Actors that can move by themselves on the board.
 */
declare const walkerKeys: readonly ["ignorant", "ignoranceSpreader"];
type Walker = typeof walkerKeys[number];
/**
 * All the different actor kinds.
 */
declare const kindKeys: readonly ["ignorant", "ignoranceSpreader", "goodGuy", "ground", "spawner", "spaghettiMonster", "player"];
 ...
 * @returns true if the given actor's kind is included in the given array of kind
 */
declare function hasOneOfKinds(actor: Actor, kinds: Array<Kind>): boolean;
/**
 ...
 * which reprensents the actors that move on the path generated from the spawns to the spaghettiMonsters
 */
declare function isWalker(actor: Actor): boolean;
/**
 ...
 */
declare function actorToString(actor: Actor): string;
/**
 ...
 * @returns The string representation of the world with the given actor in it
 */
declare function actorToStringInWorld(world: World, worldString: string, actor: Actor): string;
/**
 ...
 */
declare function filterByKinds(actors: Array<Actor>, kinds: Array<Kind>): Array<Actor>;
/**
 ...
 */
declare function translateActor(actor: Actor, movementVector: ReturnType<ActorActions["move"]>): Actor;
/**
 ...
 */
declare function findNextWaypointTarget(actors: Array<Actor>, waypointTarget: Vector2D, waypointTargetNumber: number): {
    waypointTargetNumber: number;
    waypointTarget: Actor["position"];
};
/**
 ...
 */
declare function translateAndUpdateWaypoint(actors: Array<Actor>, movingActor: Actor, movementVector: ReturnType<ActorActions["move"]>): Actor;
/**
 ...
 */
declare function isValidActorInEnvironment(world: World, actor: Actor): boolean;
/**
 ...
 * @returns the actors from the given actor array whose position respect the given position constraints
 */
declare function filterActorsByPosition(actors: Array<Actor>, xPosition?: number, yPosition?: number): Array<Actor>;
export { actorToString, actorToStringInWorld, translateActor, translateAndUpdateWaypoint, stringReplaceAt, filterByKinds, findNextWaypointTarget, isValidActorInEnvironment, filterActorsByPosition, isWalker, hasOneOfKinds, walkerKeys, kindKeys };
